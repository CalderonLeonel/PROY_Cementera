<template>
    <v-card elevation="5" outlined shaped>
        <v-dialog v-model="agregarLineaModal" max-width="700px">
            <v-card elevation="5" outlined shaped>
                <v-card-title>
                        ...
                        <v-col cols="12">
                            ...
                            <v-data-table :headers="headersLineas" :items="datosLineas" :search="buscarLineas"
                                ...
                                <template #[`item.actions`]="{ item }">
                                    ...
                                    <v-icon small class="mr-2" @click="actualizarInfoLineas(item)"
        ...
        async listarLineas() {
            ...
            await axios
                ...
                .then(function (response) {
                    ...
                    // me.listarAula(me.id_sede); estualizar tabla esta creando ciclos
                })
