                            ...
                            <v-container>
                                <v-row>
                                    <v-col cols="12">
                                        ...
                                        <v-card-title>
                                            <v-text-field v-model="buscarTipos" append-icon="mdi-magnify"
                                                label="BUSCAR TipoS" single-line hide-details></v-text-field>
                                        </v-card-title>
                                        <v-data-table :headers="headersTiposInh" :items="datosTiposInh"
                                            :search="buscarTipos" :items-per-page="5" class="elevation-1" id="tableId">
